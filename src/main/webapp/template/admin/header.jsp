            ...
            <div class="navbar-header">
                <div class="header-logo" style="padding: 10px;">
                    ...
                    <a href="#" class="brand" style="color: #FFF; font-weight: 700; letter-spacing: 1px;">
                        <img id="img-logo" src="${pageContext.request.contextPath}/resources/file/images/logoadmin.png" alt="logo" style="margin-left: 0px; padding: 4px; ">
                        <span id="brand-span" style="display: inline;">GROUP 3</span>
                    </a>
                </div>
            </div>
            <div class="navbar-menu">
                <div class="admin-info">
                    <div class="dropdown">
                        ...
                        <a href="home" style="margin-left: 30px">Xem trang  <i class="fa fa-external-link"></i> </a>
                    </div>
                </div>
