...
<div class="pagebody">
    ...
    <div class="container">
        ...
        <div class="col-sm-8">
            <h5>Thêm audio cần thiết cho bài thi:</h5>
            <form action="AdminUploadAudio" method="post" enctype="multipart/form-data" id="uploadForm">
            	...
            	<input type="text" name="part" id="part" placeholder="Part" required/>
...
<script>
    function submitForm(actionType) {
        ...
        if (actionType === 'confirm') {
            form.action = 'AdminUploadAudio?action=' + partValue; // Thay 'URL_XAC_NHAN' bằng đường dẫn muốn post đến khi xác nhận
        } else if (actionType === 'next') {
            form.action = 'AdminUploadAudio?action=0'; // Thay 'URL_TIEP_THEO' bằng đường dẫn muốn post đến khi tiếp tục
        }
